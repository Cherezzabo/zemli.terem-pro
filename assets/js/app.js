...
$(document).ready(function () {
	...
	$('#filter').on('click', '.dropdown-menu--terem>li', function (e) {
		e.preventDefault();
		$('.col--show-map-btn').removeClass('col--show-map-btn').css('padding', '0');
	...
	$('.details__tabs').on('click', '.tab > a', function (e) {
		e.preventDefault();
		var tmp = $(this).addClass('link--active').removeClass('link--gray').parent('div').siblings('div').children().removeClass('link--active').addClass('link--gray');
	});
